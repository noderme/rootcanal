                    ...
                    <>
                      <div
                        style={{
                          fontSize: 15,
                          fontWeight: 700,
                          color: displayRank <= 3 ? "#1ABC9C" : "#D4A843",
                          lineHeight: 1.3,
                          marginTop: 2,
                        }}
                      >
                        {rankShortLabel(displayRank)}
                      </div>
                      <div
                        style={{ fontSize: 11, color: "#6B7B78", marginTop: 4 }}
                      >
              ...
              {userRank == null && (
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Your practice doesn&apos;t appear in the top 60 Google
                      results
                    </div>
                    <div
                      style={{
                    ...
                    >
                      Patients searching for a dentist nearby won&apos;t find
                      you. Collecting more Google reviews is the fastest way to
                      move up.
                    </div>
                  </div>
                  {!isGrowth && (
                    ...
                    >
                      ...
                      >
                        ...
                        <div>
                          ...
                          >
                            {inTopThree
                              ? `You're in the top 3 in ${displayCity} — for now.`
                          ...
                          >
                            {inTopThree
                              ? "Stay consistent with reviews to hold your position."
                              : "Most patients choose the top 3 clinics. Reviews are the fastest way to move up."}
                          </div>
                        </div>
                      </div>
                      <div
                      ...
                      >
                        ...
                        {!inTopThree && data.healthgradesFound === false && (
                          ...
                          >
                            ...
                            >
                              ⚠️ You are losing patients right now
                            </div>
                            <div
                              style={{
                                fontSize: 11,
                            ...
                            >
                              Not in top 3 + invisible on Healthgrades =
                              patients choosing your competitors daily.
                            </div>
                          </div>
                        )}
                      </div>
